    ...
    <main class="flex-grow flex items-center justify-center px-4 py-20">
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-10">
                ...
                <p class="text-gray-500 text-sm">Únete a la mayor comunidad de pescadores</p>
            </div>
            ...
            <form action="index.php?action=register" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="email" name="email" required placeholder="ejemplo@catchly.com" class="w-full bg-input border border-gray-800 rounded-lg px-4 py-3 text-white placeholder-gray-600 focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent transition text-sm">
                </div>
                ...
                <div class="text-center mt-6">
                    <p class="text-sm text-gray-600">
                        ¿Ya tienes cuenta? <a href="index.php?action=login" class="text-accent hover:underline">Inicia sesión</a>
                    </p>
                </div>
            </form>
