<?php include __DIR__ . '/../layout/header.php'; ?>
    ...
    <main class="flex-grow container mx-auto px-4 py-20 max-w-4xl">
        ...
        <form action="index.php?action=store_post" method="POST" class="space-y-8">
            <div class="w-full h-64 border-2 border-dashed border-gray-800 rounded-xl bg-input/50 flex flex-col items-center justify-center hover:border-accent/40 hover:bg-input transition cursor-pointer group">
                ...
                <p class="text-white font-medium text-sm mb-1">Añadir fotos de la captura</p>
                <p class="text-gray-600 text-xs uppercase tracking-wide">JPG, PNG o MP4 (Próximamente)</p>
            </div>
